...
const Hero = () => {
  return (
    <div className="px-4 sm:px-6 md:px-12 mt-10">
      <div className="flex flex-col-reverse md:flex-row justify-between items-center md:items-start">
        
        {/* Left Content */}
        <div className="w-full md:w-1/2 max-w-xl space-y-5 mt-10 md:mt-16 text-center md:text-left">
        ...
        {/* Right Image */}
        <div className="mb-10 md:mb-0 md:ml-6 w-full md:w-1/2 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg flex justify-center md:justify-end">
          <img src="my.png" alt="Profile" className="w-full object-cover rounded-xl shadow-lg" />
        </div>
      </div>
